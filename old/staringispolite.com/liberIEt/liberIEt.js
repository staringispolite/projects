// Thanks for doing your part to LiberIEt the world from IE6!
// Original copy written by Jonathan Howard (jon@StaringIsPolite.com)
//
// Creative Commons
// LiberIEt is released into the wild under a Creative Commons etc-etc-Attribution License
//
...
var layerID = "liberIEt"; // Change if for some reason this ID exists already.
var needUpgrade = /MSIE 6/i.test(navigator.userAgent); // is IE6??
...
var borderColor   = "blue";    // Change to fit your color scheme.

if (needUpgrade) {
  // Hate to define CSS this way, but trying to keep to one file. I'll keep it as pretty as possible.
  var overlayCSS =  
